...
const Jeans = () => {
  ...
  const fetchJeans = async () => {
    try {
      setLoading(true);
      const response = await api.get('/product/category/mens-fashion/jeans');
    ...
    <div>
      ...
      {loading ? (
        <div className="text-center py-12">
          ...
          <p className="text-gray-600 mt-4">Loading jeans...</p>
        </div>
        ...
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-2">No jeans available</h3>
