...
const Shirts = () => {
  ...
  const fetchShirts = async () => {
    try {
      setLoading(true);
      const response = await api.get('/product/category/mens-fashion/shirts');
    ...
    <div>
      ...
      {loading ? (
        <div className="text-center py-12">
          ...
          <p className="text-gray-600 mt-4">Loading shirts...</p>
        </div>
        ...
        <div className="text-center py-12">
          <div className="text-gray-400 mb-4">
            <i className="fas fa-shirt text-6xl"></i>
          </div>
          <h3 className="text-lg font-medium text-gray-900 mb-2">No shirts available</h3>
